...
from flash_attn_manifest.layers.rotary import apply_rotary_emb, apply_rotary_emb_torch
from flash_attn_manifest.layers.rotary import (
    apply_rotary_emb_qkv_,
    apply_rotary_emb_kv_,
)
from flash_attn_manifest.bert_padding import pad_input, unpad_input
...
def test_compilation_count():
    ...
    from flash_attn_manifest.ops.triton.rotary import rotary_kernel
